...
npm install
cd ../server
npm install @google/generative-ai bcrypt cors csv-parse dotenv exceljs express express-fileupload express-rate-limit google-auth-library jsonwebtoken multer mysql2 nodemailer openai pdfkit sequelize socket.io uuid xlsx groq-sdk
