...
npm install
cd ../server
npm install @google/generative-ai bcrypt cors csv-parse dotenv exceljs express express-fileupload express-rate-limit google-auth-library groq-sdk jsonwebtoken mammoth multer mysql2 nodemailer openai pdf-parse pdfkit sequelize socket.io uuid xlsx
